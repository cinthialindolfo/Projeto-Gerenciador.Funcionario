...
public class Funcionario {
    ...
    public String toString() {
        return "O funcionário " + this.nome + ", nasceu na data "+ this.dataDeNasc
                + " é portador do CPF n° " + this.cpf + " trabalha no setor "
                + this.setor + " onde está na empresa desde a data: " + this.dataDeAdmissao
                + " e reside na cidade de " + this.cidadeNatal + '\n';
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(nome, that.nome)
                && Objects.equals(dataDeNasc, that.dataDeNasc)
                && Objects.equals(cpf, that.cpf)
                && Objects.equals(setor, that.setor)
                && Objects.equals(dataDeAdmissao, that.dataDeAdmissao)
                && Objects.equals(cidadeNatal, that.cidadeNatal);
    }
    @Override
    public int hashCode() {
